//Известно, что в массиве x(n) есть один элемент =1. Определить где он находится, и упорядочить по убыванию элементы, расположенные за ним. Выдать на экран номер элемента и упорядоченный массив.
