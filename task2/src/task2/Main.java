// Известно, что в массиве x(n) есть один элеменнт = 1. Определить где он находится, и упорядочить по убыванию элементы, располоенные за перед ним. Выдать на экран номер элемента и упорядоченный массив
